...
function Card({list}) {
    ...
    return (
        <>
            {
                list.map((item) => (
                    <div key={item.id} id={item.id} className='w-40 m-1 h-fit flex flex-col rounded-xl text-center relative group overflow-hidden bg-white hover:cursor-pointer lg:w-52'>
